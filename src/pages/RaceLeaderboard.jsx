...
const PositionBadge = ({ position }) => {
  ...
  return (
    <span className="text-blue-300 font-bold text-lg w-8 text-center">
      {position}
    </span>
  )
}
...
const statusBadge = (status) => {
  ...
  if (status === 'final')
    return (
      <span className="bg-[#0e2040] border border-blue-900 text-blue-300 text-xs font-bold px-2 py-1 rounded uppercase">
        Final
      </span>
    )
  return (
...
const RaceLeaderboard = () => {
  ...
  return (
    <div>
      <Link
        to="/races"
        className="text-blue-300 hover:text-red-400 text-sm font-bold uppercase tracking-wide mb-6 inline-block"
      >
        ← Back to Races
      </Link>
      ...
      <div className="mb-8">
        ...
        <p className="text-blue-300/60">🏟️ {race.track}</p>
      </div>
            ...
            >
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="text-right">
                  ...
                  <div className="text-blue-300/50 text-xs uppercase tracking-wide">
                    total
                  </div>
                </div>
              </div>
